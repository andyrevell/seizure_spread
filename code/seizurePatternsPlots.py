...
import seizurePattern

pathFigure = os.path.join(path, "figures")
#%%
...
pathFigureOverview = os.path.join(pathFigure, "overview")
...
version = 44
fpath_wavenet = os.path.join(path,f"data/processed/model_checkpoints/wavenet/v{version:03d}.hdf5") #version 7 of wavenet is good
fpath_1dCNN = os.path.join(path,f"data/processed/model_checkpoints/1dCNN/v{version:03d}.hdf5") #version 7 of wavenet is good
fpath_lstm = os.path.join(path,f"data/processed/model_checkpoints/lstm/v{version:03d}.hdf5") #version 7 of wavenet is good
...
fnameFigChannels = os.path.join(pathFigureOverview, "exampleProbabilityChannels.png")
...
fnameFig = os.path.join(pathFigureOverview, "seizurePatternHeatmap.png")
...
fnameFig = os.path.join(pathFigureOverview, "seizurePatternHeatmapThreshold.png")
#plt.savefig( fnameFig, transparent=True)
...
fnameFig = os.path.join(pathFigureOverview, "exampleEEGspread_single_channel.png")
...
fnameFig = os.path.join(pathFigureOverview, "exampleEEGspread_single_channel2.png")
...
fnameFig = os.path.join(pathFigureOverview, "exampleEEG_periIctal.png")
...
fnameFig = os.path.join(pathFigureOverview, "exampleEEG_interictal.png")
...
fnameFig = os.path.join(pathFigureOverview,"Class0Class1", "class0_01.png")
...
fnameFig = os.path.join(pathFigureOverview, "exampleEEGspread_multipleChannels.png")
...
fnameFig = os.path.join(pathFigureOverview, "exampleProbability.png")
#plt.savefig( fnameFig, transparent=True)
...
fnameFig = os.path.join(pathFigureOverview, "power.png")
#plt.savefig( fnameFig, transparent=True)
...
fnameFig = os.path.join(pathFigureOverview, "linelength.png")
#plt.savefig( fnameFig, transparent=True)
...
fnameFig = os.path.join(pathFigureOverview, "strengthNeg.png")
plt.savefig( fnameFig, transparent=True)
...
fnameFig = os.path.join(pathFigureOverview, "ONSET_withMarkers.png")
...
fnameFig = os.path.join(pathFigureOverview, "ONSET_WITHOUT_markers.png")
