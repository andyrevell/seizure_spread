...
fpath_wavenet = os.path.join(path,"data/processed/model_checkpoints/wavenet/v035.hdf5") #version 7 of wavenet is good
fpath_1dCNN = os.path.join(path,"data/processed/model_checkpoints/1dCNN/v035.hdf5") #version 7 of wavenet is good
fpath_lstm = os.path.join(path,"data/processed/model_checkpoints/lstm/v035.hdf5") #version 7 of wavenet is good
